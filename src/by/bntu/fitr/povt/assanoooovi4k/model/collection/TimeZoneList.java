package by.bntu.fitr.povt.assanoooovi4k.model.collection;
...
public class TimeZoneList {
    ...
    static {
        ...
        ZONEMAPPINGS.add(new TimeZoneMapping("N. Central Asia Standard Time", "Asia/Novosibirsk", "(UTC +07:00) Novosibirsk"));
        ...
        ZONEMAPPINGS.add(new TimeZoneMapping("Eastern Standard Time", "America/Indianapolis", "(UTC -05:00) Indiana (East)"));
        ZONEMAPPINGS.add(new TimeZoneMapping("US Mountain Standard Time", "America/Phoenix", "(UTC -07:00) Arizona"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC", "Etc/GMT", "(UTC) Coordinated Universal Time"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC+12", "Etc/GMT-12", "(UTC +12:00) Coordinated Universal Time+12"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC-02", "Etc/GMT+2", "(UTC -02:00) Coordinated Universal Time-02"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC+13", "Etc/GMT-13", "(UTC +13:00) Coordinated Universal Time+13"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC-11", "Etc/GMT+11", "(UTC -11:00) Coordinated Universal Time-11"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC-09", "Etc/GMT+9", "(UTC -09:00) Coordinated Universal Time-9"));
        ZONEMAPPINGS.add(new TimeZoneMapping("UTC-08", "Etc/GMT+8", "(UTC -08:00) Coordinated Universal Time-8"));
    ...
    private TimeZoneList() {
        HashSet<String> availableIdsSet = new HashSet<>(ZoneId.getAvailableZoneIds());
